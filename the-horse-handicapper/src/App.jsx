...
// ---------------------------------------------------------------------------
function RaceSummaryCard({ race, summary, onOpen, onAskAI }) {
...
// RACE DETAIL VIEW
// ---------------------------------------------------------------------------
function RaceDetail({ race, summary, onUpdateRace, onAddHorse, onEditHorse, onSnapshotOdds, bankroll, onAskAI }) {
...
// DASHBOARD VIEW
// ---------------------------------------------------------------------------
function Dashboard({ card, summaries, onOpenRace, onAddRace, onAskAI }) {
  const stats = useMemo(() => {
    ...
    <div className="app-shell">
      ...
      <main className="app-main">
        ...
        {activeTab === "dashboard" && !openRace && (
          <Dashboard card={activeCard} summaries={summaries} onOpenRace={setOpenRaceId} onAddRace={addRace} onAskAI={askAIAbout} />
        )}
        ...
        {activeTab === "bankroll" && (
          <BankrollManager bankroll={bankroll} onChange={setBankroll} card={activeCard} summaries={summaries} />
        )}
      </main>
