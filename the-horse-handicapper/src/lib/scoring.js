...
// Tightened after real-world review showed suggested stakes were too
// aggressive relative to actual results — these are deliberately conservative
// until the app has enough tracked history (see betTracking.js) to justify
// sizing up. Treat every number this produces as informational, not a
// confident stake recommendation, until that history exists.
export const KELLY_FRACTION_CAP = 0.125; // one-eighth-Kelly ceiling (was quarter-Kelly)
export const KELLY_MAX_PCT_OF_BANKROLL = 0.02; // hard cap regardless of Kelly math (was 5%)
// Below this many tracked, settled bets, Kelly output should be labeled
// "informational" in the UI rather than presented as a sized recommendation —
// see betTracking.js for where settled-bet history accumulates.
export const KELLY_MIN_TRACKED_BETS_FOR_CONFIDENCE = 30;
